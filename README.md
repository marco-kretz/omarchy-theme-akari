...
Three versions of the same wallpaper are included in `backgrounds/`:

| File | Resolution |
| --- | --- |
| `01-akari-4k.png` | 3840 × 2160, selected first |
| `02-akari-2k.png` | 2560 × 1440 |
| `03-akari-fhd.png` | 1920 × 1080 |
